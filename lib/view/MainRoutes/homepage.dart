...
import 'package:flutter_project/view/DrawerRoutes/wallet_screen.dart';
...
class _Homepage extends State<Homepage> {
  ...
  void initState() {
    super.initState();
    context.read<HomePageModel>().loadApts(mounted,context.read<AuthProvider>().token!);
    /////////////////////////////////////////////////dont forget it
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: CustomDrawer(
        ...
        profileImg: context.watch<UserModel>().getProfileImg,
        ...
        children: [
          LayoutBuilder(
            builder: (context, Constraints) {
              final categories = context.watch<HomePageModel>().categoryList;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        categories.length <= 1
                            ? SizedBox() // أو عرض مؤشر تحميل أو رسالة
                            : ListView.builder(
                                shrinkWrap: true,
                        ...
                        ListView.builder(
                          ...
                          itemCount: context
                              ...
                              .length,
                          itemBuilder: (context, i) {
                            print("${categories[0].apts[i].toString()}");
                            return ShowAptsVertical1(
                              cardHeight: Constraints.maxHeight,
                              cardWidth: Constraints.maxWidth,
                              apt: categories[0].apts[i],
